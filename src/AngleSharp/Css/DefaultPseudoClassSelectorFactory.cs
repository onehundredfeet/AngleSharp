...
//Custom class names
            { PseudoClassNames.Visible, new PseudoClassSelector(el => el.IsVisible, PseudoClassNames.Visible) },
            { PseudoClassNames.Hidden, new PseudoClassSelector(el => el.IsHidden, PseudoClassNames.Hidden) },
            { PseudoClassNames.PrimaryDown, new PseudoClassSelector(el => el.IsPrimaryDown, PseudoClassNames.PrimaryDown) },
            { PseudoClassNames.PrimaryDownEdge, new PseudoClassSelector(el => el.IsPrimaryDownEdge, PseudoClassNames.PrimaryDownEdge) },
            { PseudoClassNames.PrimaryUp, new PseudoClassSelector(el => el.IsPrimaryUp, PseudoClassNames.PrimaryUp) },
            { PseudoClassNames.PrimaryUpEdge, new PseudoClassSelector(el => el.IsPrimaryUpEdge, PseudoClassNames.PrimaryUpEdge) },
            { PseudoClassNames.SecondaryDown, new PseudoClassSelector(el => el.IsSecondaryDown, PseudoClassNames.SecondaryDown) },
            { PseudoClassNames.SecondaryDownEdge, new PseudoClassSelector(el => el.IsSecondaryDownEdge, PseudoClassNames.SecondaryDownEdge) },
            { PseudoClassNames.SecondaryUp, new PseudoClassSelector(el => el.IsSecondaryUp, PseudoClassNames.SecondaryUp) },
            { PseudoClassNames.SecondaryUpEdge, new PseudoClassSelector(el => el.IsSecondaryUpEdge, PseudoClassNames.SecondaryUpEdge) },
            { PseudoClassNames.ButtonCold, new PseudoClassSelector(el => el.IsButtonCold, PseudoClassNames.ButtonCold) },
            { PseudoClassNames.ButtonPrimed, new PseudoClassSelector(el => el.IsButtonPrimed, PseudoClassNames.ButtonPrimed) },
